 ...
 */
@Component
public class EntityCacheServiceImpl<PK extends Comparable<PK> & Serializable, V extends Entity<PK>>
    implements EntityCacheService<PK, V> {
  ...
  private LoadingCache<PK, V> cache =
